...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-169723177-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

        gtag('config', 'UA-169723177-1');
        </script>
...
<br><center>	<?php
	...
	echo "<a href=\"/editteacher.php\">HOME</a>&nbsp&nbsp&nbsp&nbsp<a href=\"/logout.php\">LOGOUT</a>&nbsp&nbsp&nbsp&nbsp<a href=\"/searchname.php\">SEARCH</a>";
}
	 else
	 {
