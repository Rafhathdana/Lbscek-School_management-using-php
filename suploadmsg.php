...
if (isset($_SESSION['login']))
{
   ...
   $Query = "SELECT * FROM student WHERE register_number = '$loginSession' AND admission_number = '$rafSession'";
   require("main.php");
...
$qwe= "$date";
mkdir("uploads/notice/" . $_SESSION['login']);
$target_dir = "uploads/notice/" . $_SESSION['login'] . "/";
