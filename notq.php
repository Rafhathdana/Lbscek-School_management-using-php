﻿﻿﻿﻿﻿﻿﻿﻿﻿<?php			
			include("student.php");
$Querye="SELECT * from chats where (too = '$id' or too = '$rd') and subject = '$n' and timemsg = '$ti' order by timemsg ";						$dbresultm=mysql_query($Querye);		
...
$Querys="UPDATE chats SET status =  'online' where (too = '$id' or too = '$rd') and subject = '$n' and timemsg = '$ti' and status = 'offline'";						$dbresultn=mysql_query($Querys);
}			
			else
			{
