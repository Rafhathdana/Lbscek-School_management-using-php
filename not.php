﻿<?php			
			include("student.php");
$Querye="SELECT * from chats where too = '$id' and subject = '$n' and timemsg = '$ti' order by timemsg ";						$dbresultm=mysqli_query($conn,$Querye);		
...
$Querys="UPDATE chats SET status =  'online' where too = '$id' and subject = '$n' and timemsg = '$ti' and status = 'offline'";						$dbresultn=mysqli_query($conn,$Querys);
}			
			else
			{
