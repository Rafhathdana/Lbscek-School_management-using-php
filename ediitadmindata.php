...
echo "<form method=post name=f1 action='editsavee3.php' enctype='multipart/form-data'>";
...
echo "<div class='menu'>Photo:
		&nbsp&nbsp" . "<div class='galery'><img src='$row[9]'></div><br>";
				echo "<font color = red> Edit Photo </font> :  " . "<input type='file' name='fileToUpload' id='fileToUpload' value = '$row[9]'>" . "</div>";
